...
function _medium2_1(d3,team_4,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _medium2_2(d3,data,drag,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1000;
...
function _medium3_1(d3,team_4,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _medium3_2(d3,data,drag,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1000;
...
function _medium4_1(d3,team_4,drag,invalidation)
{
  // 指定圖表的尺寸。
  const width = 500;
  const height = 400;
...
function _medium4_2(d3,data,drag,invalidation)
{
   // 指定圖表的尺寸。
  const width = 1500;
  const height = 1000;
...
md`### Reference
<ol>
  <li>https://avaliya.github.io/vis2023f/hw05/src/medium/</li>
  <li>https://jasonyen1009.github.io/vis2023f/hw05/src/medium/</li>
  <li>https://t112598018.github.io/vis2023f/hw05/src/medium/</li>
</ol>`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("medium2_1")).define("medium2_1", ["d3","team_4","drag","invalidation"], _medium2_1);
  main.variable(observer("medium2_2")).define("medium2_2", ["d3","data","drag","invalidation"], _medium2_2);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer("medium3_1")).define("medium3_1", ["d3","team_4","drag","invalidation"], _medium3_1);
  main.variable(observer("medium3_2")).define("medium3_2", ["d3","data","drag","invalidation"], _medium3_2);
  main.variable(observer()).define(["md"], _11);
  main.variable(observer("medium4_1")).define("medium4_1", ["d3","team_4","drag","invalidation"], _medium4_1);
  main.variable(observer("medium4_2")).define("medium4_2", ["d3","data","drag","invalidation"], _medium4_2);
