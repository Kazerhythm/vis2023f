...
function _strong1_1(d3,team_4,drag,url_list,invalidation)
{
  // 指定圖表的尺寸。
  const width = 1000;
  const height = 400;
...
md`### Reference
<ol>
  <li>https://avaliya.github.io/vis2023f/hw05/src/strong/</li>
  <li>https://jasonyen1009.github.io/vis2023f/hw05/src/strong/</li>
  <li>https://t112598018.github.io/vis2023f/hw05/src/strong/</li>
</ol>`
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("strong1_1")).define("strong1_1", ["d3","team_4","drag","url_list","invalidation"], _strong1_1);
