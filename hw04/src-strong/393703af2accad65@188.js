...
<h3>從上圖中，我們可以看出：
  <ul>
    <li> 問卷中，大部分回答者來自於工作室內的藝術從業者，佔比約40%；其次是在替代空間工作者。</li>
    <li> 有一半以上是來自工作室和替代空間的藝術工作者，佔比約57.3%。</li>
    <li> 為降低碳足跡最多人採取的減少碳排放行動是減少包裝和文宣印刷。</li>
    <li> 在美術館工作的藝術家他們較少選擇使用再生材料作為主要環保措施。</li>
...
d3
  ...
  .range(["#7DB9DE","#A5DEE4","#51A8DD","#005CAF","#58B2DC","#4E4F97"])
  .unknown("#81C7D4")
)}
